...
1. Open [flink_app_def_stream_position_trim_horizon.json](./src/main/resources/flink_app_def_stream_position_trim_horizon.json) andd update the following values:
